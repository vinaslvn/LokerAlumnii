...
<div class="animated bounceInDown">
  <div class="container">
    ...
    <form  action="{{url ('loginalumni')}}" method="post" name="form1" class="box" onsubmit="return checkStuff()">
      @csrf
      <h4>Login<span>Alumni</span></h4>
      ...
      {{-- <input type="text" name="nis" placeholder="NIS" autocomplete="off"> --}}
        ...
        <a href="registeralumni" class="dnthave">Don’t have an account? Sign up</a>
  </div> 
       {{-- <div class="footer">

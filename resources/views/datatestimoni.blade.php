                            ...
                            <div class="body">
                                <div class="table-responsive ms-3 me-3">
                                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                        <a href="{{ url ('datatestimoni/add')}}"><button class="btn btn-primary margin-right mt-3" type="submit">+ Tambah Data</button></a>
                                        <thead>
                                            <tr class="tet-center">
                                        ...
                                        <tbody>
                                           ...
                                           <tr class="bg-white border-b border-dashed dark:bg-gray-800 dark:border-gray-700">
                                               ...
                                               <td class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                <a href="/datatestimoni/hapus/{{$item->id}}"><i class="fas fa-trash-alt"></i></a>
                                                <a href="/datatestimoni/edit/{{$item->id}}"><i class="fas fa-edit"></i></a>
